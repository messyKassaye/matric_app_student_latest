...
public class TextBookFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final View view= inflater.inflate(R.layout.fragment_text_book, container, false);
        ...
        dbReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if (dataSnapshot.exists()){
                    ...
                    for (DataSnapshot dataSnapshot1: dataSnapshot.getChildren()){
                        ...
                        if (uploadsModel.getStream().equals(logedUserStream)){
                            if (uploadsModel.getBookType().equalsIgnoreCase("Textbook")){
                ...
                if (referenceBooks.size()<=0){
                    noReferenceBooksFound.setText("Reference book is not found ):");
