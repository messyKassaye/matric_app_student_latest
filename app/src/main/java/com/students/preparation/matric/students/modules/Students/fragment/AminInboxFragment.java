...
public class AminInboxFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final View view= inflater.inflate(R.layout.fragment_amin_inbox, container, false);
                ...
                if (dataSnapshot.exists()){
                    ...
                    for (DataSnapshot dataSnapshot1: dataSnapshot.getChildren()){
                        ...
                        if (uploadsModel.getStream().equals(logedUserStream)){
                            if (uploadsModel.getBookType().equalsIgnoreCase("Admin inbox")){
                    ...
                    if (referenceBooks.size()<=0){
                        noReferenceBooksFound.setText("Admin inbox is not found ):");
